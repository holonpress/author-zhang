...
1. 确认文章在 `_posts/{YYYY-MM-DD-slug}.md`，带完整 Jekyll front matter
2. `git add _posts/ && git commit -m "article: {标题}"`
...
| 完整文风研究 | `skills/horse-style-writer/references/文风研究.md` | 风格困惑时重读 |
| 发表文章 | `_posts/` | 最终输出（Jekyll front matter 格式） |
| 草稿 | `_drafts/` | 写作中的草稿 |
